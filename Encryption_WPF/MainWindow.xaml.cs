...
namespace Encryption_WPF
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            this._Option = btnMD5.Content.ToString();
            lbTitle.Content = this._Option;
        }
        ...
        private void ButtonOption_Click(object sender, RoutedEventArgs e)
        {
            if (sender is Button)
            {
                ...
                _Option = tempBtn.Content.ToString();
                lbTitle.Content = _Option;
            }
            else
            {
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ButtonEncryptOrDecrypt_Click(object sender, RoutedEventArgs e)
        {
            if (sender is Button)
            {
                ...
                Button tempBtn = new Button();
                tempBtn = sender as Button;
                switch (tempBtn.Content.ToString())
                {
                    case "加密":
                        EncrptOperation();
                        break;
